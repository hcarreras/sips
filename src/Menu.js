        ...
        h('div', {className: 'menu middle'},
          h('div', {className: 'menu inner'},
            h('div', { style: menuIsOpen ? {} : { opacity: 0, pointerEvents: 'none' } },
              ...
              gameReady && h('div', {className: 'select-game'},
                h('div', {className: 'header'}, 'Select game'),
                h(Button, { variant: 'contained', onClick: () => this.startGame(CLASSIC_EDITION)}, 'Classic'),
                h(Button, { variant: 'contained', onClick: () => this.startGame(TOGA_EDITION)}, 'Toga Edition'),
                h(Button, { variant: 'contained', onClick: () => this.startGame(WELLNESS_EDITION)}, 'Wellness Edition')),
              h('div', {className: 'input-container'},
                h('div', {className: 'header'}, 'Players'),
                ...
                h(IconButton, {
                  classes: { root: 'add-player-button' },
                  onClick: this.addPlayer
                }, h(Add, { fontSize: 'large', color: 'primary' })))),
